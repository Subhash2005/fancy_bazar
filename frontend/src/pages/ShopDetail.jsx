...
const ALL_SHOPS = [
    {
        ...
        items: [
            { id: 'ball-pen-blue-pack-10', name: 'Ball Pen Blue (Pack of 10)', price: 99, originalPrice: 120, image: '/images/prod_ballpen.png', brand: 'Reynolds', rating: 4.5, reviews: 210, inStock: true, tag: 'Best Seller' },
            { id: 'fountain-pen-ink-cartridges', name: 'Fountain Pen with Ink Cartridges', price: 599, originalPrice: 750, image: '/images/prod_fountain_pen.png', brand: 'Parker', rating: 4.8, reviews: 98, inStock: true, tag: 'Premium' },
            { id: 'mechanical-pencil-05mm-pack-3', name: 'Mechanical Pencil (0.5mm, Pack of 3)', price: 149, originalPrice: 180, image: '/images/prod_mech_pencil.png', brand: 'Pentel', rating: 4.6, reviews: 134, inStock: true, tag: null },
            { id: 'ultrasmooth-hb-pencils-pack-12', name: 'Ultrasmooth HB Pencils (Pack of 12)', price: 69, originalPrice: 85, image: '/images/prod_hb_pencils.png', brand: 'Apsara', rating: 4.7, reviews: 320, inStock: true, tag: 'Popular' },
            { id: 'highlighter-pens-6-colors', name: 'Highlighter Pens (6 Colors)', price: 199, originalPrice: 240, image: '/images/prod_highlighter6.png', brand: 'Stabilo', rating: 4.9, reviews: 445, inStock: true, tag: '🔥 Trending' },
            { id: 'eraser-white-vinyl-pack-5', name: 'Eraser (White Vinyl, Pack of 5)', price: 39, originalPrice: 50, image: '/images/prod_eraser.png', brand: 'Natraj', rating: 4.3, reviews: 67, inStock: true, tag: null },
            { id: 'yellow-highlighter-marker-pack-2', name: 'Yellow Highlighter Marker (Pack of 2)', price: 59, originalPrice: 70, image: '/images/prod_yellow_highlighter.png', brand: 'Luxor', rating: 4.4, reviews: 112, inStock: true, tag: null },
            { id: 'ink-pen-refills-blue-pack-20', name: 'Ink Pen Refills (Blue, Pack of 20)', price: 49, originalPrice: 60, image: '/images/prod_ink_refills.png', brand: 'Reynolds', rating: 4.2, reviews: 88, inStock: true, tag: null },
            { id: 'marker-pens-permanent-12-colors', name: 'Marker Pens Permanent (12 Colors)', price: 249, originalPrice: 300, image: '/images/prod_markers12.png', brand: 'Camlin', rating: 4.6, reviews: 176, inStock: true, tag: 'New' },
        ],
    },
    {
        ...
        items: [
            { id: 'a4-paper-ream-500-sheets', name: 'A4 Paper Ream (500 Sheets)', price: 249, originalPrice: 299, image: '/images/prod_a4_ream.png', brand: 'PaperMate', rating: 4.7, reviews: 310, inStock: true, tag: 'Best Seller' },
            { id: 'notebook-a5-spiral-200-pages', name: 'Notebook A5 Spiral (200 Pages)', price: 129, originalPrice: 160, image: '/images/prod_notebook_a5.png', brand: 'Classmate', rating: 4.8, reviews: 524, inStock: true, tag: '🔥 Trending' },
            { id: 'index-cards-100-ruled', name: 'Index Cards (100 Pack, Ruled)', price: 149, originalPrice: 180, image: 'https://images.unsplash.com/photo-1512138664757-360e0aad5132?w=400&q=80', brand: 'Oxford', rating: 4.4, reviews: 89, inStock: true, tag: null },
            { id: 'kraft-paper-roll-3m', name: 'Kraft Paper Roll (3 meters)', price: 129, originalPrice: 155, image: 'https://images.unsplash.com/photo-1607344645866-009c320b63e0?w=400&q=80', brand: 'CraftMate', rating: 4.3, reviews: 67, inStock: true, tag: null },
            { id: 'xtra-wide-sticky-notes-5x5-4pads', name: 'Xtra Wide Sticky Notes (5×5, 4 Pads)', price: 249, originalPrice: 299, image: 'https://images.unsplash.com/photo-1544396821-4bc158d290b3?w=400&q=80', brand: 'Post-it', rating: 4.9, reviews: 387, inStock: true, tag: 'Popular' },
        ],
    },
    {
        ...
        items: [
            { id: 'oil-pastels-25-colors', name: 'Oil Pastels (25 Colors)', price: 199, originalPrice: 240, image: '/images/oil_pastels_set.png', brand: 'Camlin', rating: 4.8, reviews: 213, inStock: true, tag: '🔥 Trending' },
            { id: 'watercolor-paint-set-24-colors', name: 'Watercolor Paint Set (24 Colors)', price: 299, originalPrice: 360, image: '/images/watercolor_set.png', brand: 'Camlin', rating: 4.9, reviews: 332, inStock: true, tag: 'Premium' },
            { id: 'drawing-compass-set', name: 'Drawing Compass Set', price: 199, originalPrice: 250, image: 'https://images.unsplash.com/photo-1602080858428-35be98ed7905?w=400&q=80', brand: 'Camlin', rating: 4.5, reviews: 145, inStock: true, tag: null },
            { id: 'kraft-paper-roll-3m', name: 'Kraft Paper Roll (3 meters)', price: 129, originalPrice: 155, image: 'https://images.unsplash.com/photo-1607344645866-009c320b63e0?w=400&q=80', brand: 'CraftMate', rating: 4.3, reviews: 67, inStock: true, tag: null },
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            { id: 'a4-paper-ream-500-sheets', name: 'A4 Paper Ream (500 Sheets)', price: 249, originalPrice: 299, image: '/images/prod_a4_ream.png', brand: 'PaperMate', rating: 4.7, reviews: 310, inStock: true, tag: 'Best Seller' },
            { id: 'ball-pen-blue-pack-10', name: 'Ball Pen Blue (Pack of 10)', price: 99, originalPrice: 120, image: '/images/prod_ballpen.png', brand: 'Reynolds', rating: 4.5, reviews: 210, inStock: true, tag: null },
            { id: 'notebook-a5-spiral-200-pages', name: 'Notebook A5 Spiral (200 Pages)', price: 129, originalPrice: 160, image: '/images/prod_notebook_a5.png', brand: 'Classmate', rating: 4.8, reviews: 524, inStock: true, tag: '🔥 Trending' },
            { id: 'highlighter-pens-6-colors', name: 'Highlighter Pens (6 Colors)', price: 199, originalPrice: 240, image: '/images/prod_highlighter6.png', brand: 'Stabilo', rating: 4.9, reviews: 445, inStock: true, tag: 'Popular' },
            { id: 'watercolor-paint-set-24-colors', name: 'Watercolor Paint Set (24 Colors)', price: 299, originalPrice: 360, image: '/images/watercolor_set.png', brand: 'Camlin', rating: 4.9, reviews: 332, inStock: true, tag: 'Premium' },
            { id: 'stapler-with-1000-staples', name: 'Stapler with 1000 Staples', price: 299, originalPrice: 360, image: '/images/stapler_1000_staples.png', brand: 'Kangaro', rating: 4.7, reviews: 256, inStock: true, tag: null },
            ...
            { id: 'oil-pastels-25-colors', name: 'Oil Pastels (25 Colors)', price: 199, originalPrice: 240, image: '/images/oil_pastels_set.png', brand: 'Camlin', rating: 4.8, reviews: 213, inStock: true, tag: null },
            { id: 'xtra-wide-sticky-notes-5x5-4pads', name: 'Xtra Wide Sticky Notes (5×5, 4 Pads)', price: 249, originalPrice: 299, image: 'https://plus.unsplash.com/premium_photo-1685136482322-0ac2453016d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMjA3fDB8MXxzZWFyY2h8MXx8cG9zdCUyMGl0JTIwbm90ZXMlMjBzdGlja3klMjBub3RlcyUyMHN0YWNrfGVufDB8fHx8MTc3MzQ4MTkxNHww&ixlib=rb-4.1.0&q=80&w=400', brand: 'Post-it', rating: 4.9, reviews: 387, inStock: true, tag: null },
            { id: 'paper-clips-silver-box-100', name: 'Paper Clips (Silver, Box of 100)', price: 39, originalPrice: 50, image: 'https://plus.unsplash.com/premium_photo-1683309558415-6724de9be256?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMjA3fDB8MXxzZWFyY2h8MXx8cGFwZXIlMjBjbGlwcyUyMG9mZmljZSUyMG1ldGFsfGVufDB8fHx8MTc3MzQ4MTkxNXww&ixlib=rb-4.1.0&q=80&w=400', brand: 'Kores', rating: 4.4, reviews: 312, inStock: true, tag: null },
            { id: 'mechanical-pencil-05mm-pack-3', name: 'Mechanical Pencil (0.5mm, Pack of 3)', price: 149, originalPrice: 180, image: '/images/prod_mech_pencil.png', brand: 'Pentel', rating: 4.6, reviews: 134, inStock: true, tag: null },
            { id: 'eraser-white-vinyl-pack-5', name: 'Eraser (White Vinyl, Pack of 5)', price: 39, originalPrice: 50, image: '/images/prod_eraser.png', brand: 'Natraj', rating: 4.3, reviews: 67, inStock: true, tag: null },
        ],
    },
    {
        ...
        items: [
            { id: 'letter-file-folder-a4-pack-5', name: 'Letter File Folder (A4, Pack of 5)', price: 179, originalPrice: 220, image: 'https://plus.unsplash.com/premium_photo-1677402408071-232d1c3c3787?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMjA3fDB8MXxzZWFyY2h8MXx8ZmlsZSUyMGZvbGRlciUyMGRvY3VtZW50JTIwb2ZmaWNlfGVufDB8fHx8MTc3MzQ4MTkxNXww&ixlib=rb-4.1.0&q=80&w=400', brand: 'Solo', rating: 4.5, reviews: 143, inStock: true, tag: 'Best Seller' },
            { id: 'ziplock-storage-bags-a4-pack-50', name: 'Zip-Lock Storage Bags (A4, Pack of 50)', price: 179, originalPrice: 210, image: 'https://plus.unsplash.com/premium_photo-1661944522798-0ec14d717135?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMjA3fDB8MXxzZWFyY2h8MXx8emlwbG9jfGVufDB8fHx8MTc3MzQ4MTkxNnww&ixlib=rb-4.1.0&q=80&w=400', brand: 'Deli', rating: 4.4, reviews: 98, inStock: true, tag: null },
            ...
            { id: 'paper-clips-silver-box-100', name: 'Paper Clips (Silver, Box of 100)', price: 39, originalPrice: 50, image: 'https://plus.unsplash.com/premium_photo-1678007790650-e768e15d297a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMjA3fDB8MXxzZWFyY2h8MXx8cGFwZXIlMjBjbGlwcyUyMG1ldGFsJTIwc2lsdmVyfGVufDB8fHx8MTc3MzQ4MTkxOHww&ixlib=rb-4.1.0&q=80&w=400', brand: 'Kores', rating: 4.4, reviews: 312, inStock: true, tag: 'Popular' },
        ],
    },
]
                            ...
                            <article key={item.id} className={`sd-item-card${isPreviewOpen ? ' sd-item-card--open' : ''}`}>
                                ...
                                <div className="sd-item-body">
                                    ...
                                    <div className="sd-item-actions">
                                        ...
                                        <button className="sd-btn-cart" onClick={() => navigate(`/product/${item.id}`)} disabled={!item.inStock}>
                                            <FiShoppingCart size={15} /> View to Add
                                        </button>
                                    </div>
                                </div>
                            </article>
